...
CREATE TABLE `products` (
  ...
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '商品詳細描述',
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '刊登時間',
  PRIMARY KEY (`product_id`),
  KEY `idx_products_seller` (`seller_user_id`),
  KEY `idx_products_category` (`category_id`),
  CONSTRAINT `fk_products_category_final` FOREIGN KEY (`category_id`) REFERENCES `categories` (`category_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_products_seller_final` FOREIGN KEY (`seller_user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品核心資料表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'parts_heirlooms'
--
...
-- Dump completed on 2025-05-15 10:40:26
